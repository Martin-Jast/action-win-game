...
namespace Engine
{
    public static class World
    {
        ...
        public const int ITEM_ID_BASTARD_SWORD = 11;
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Weapon(ITEM_ID_BASTARD_SWORD, "Bastard sword", "Bastard swords", 5, 15, 150));
        ...
        private static void PopulateLocations()
        {
            ...
            bobTheRatCatcher.AddItemToInventory(ItemByID(ITEM_ID_BASTARD_SWORD), 2);
